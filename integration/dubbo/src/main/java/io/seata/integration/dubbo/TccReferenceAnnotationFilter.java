...
public class TccReferenceAnnotationFilter implements Filter {
    ...
    public Result invoke(Invoker<?> invoker, Invocation invocation) throws RpcException {
        try {
            ...
            //try method
            if (businessAction != null && StringUtils
                    .isEmpty(RootContext.getXIDInterceptorType())) {
                //save the xid
            ...
            LOGGER.error("Tcc filter registration transaction branch exception:{}", e.getMessage(), e);
