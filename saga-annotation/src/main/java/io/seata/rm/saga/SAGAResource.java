...
public class SAGAResource implements Resource {
    ...
    private String rollbackRpcVersion;

    private String rollbackRpcClass;
    ...
    public String getRollbackRpcVersion() {
        return rollbackRpcVersion;
    }
    
    public void setRollbackRpcVersion(String rollbackRpcVersion) {
        this.rollbackRpcVersion = rollbackRpcVersion;
    }

    public String getRollbackRpcClass() {
        return rollbackRpcClass;
    }

    public void setRollbackRpcClass(String rollbackRpcClass) {
        this.rollbackRpcClass = rollbackRpcClass;
    }
