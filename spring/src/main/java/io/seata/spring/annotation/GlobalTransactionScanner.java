...
public class GlobalTransactionScanner extends AbstractAutoProxyCreator
    ...
    public GlobalTransactionScanner(String applicationId, String txServiceGroup, int mode) {
        this(applicationId, txServiceGroup, mode, null, true);
    }
     ...
     */
    public GlobalTransactionScanner(String applicationId, String txServiceGroup, FailureHandler failureHandlerHook, boolean hsfInvoker) {
        this(applicationId, txServiceGroup, DEFAULT_MODE, failureHandlerHook, hsfInvoker);
    }
